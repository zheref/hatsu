...
> **`v0.35.0` — a bot reviewer is a different route.** `sharingan` records how to re-request Copilot, why `gh pr edit` and REST silently fail on a Bot, and why REST's `requested_reviewers` is the wrong place to verify.
>
