...
codex_installed_count=$(( $(count_skills "$hatsu_root/surfaces/codex") + 1 + 1 + $(count_files "$hatsu_root/surfaces/codex/agents" '*.toml') ))
...
cursor_installed_count=$(( $(count_skills "$hatsu_root/surfaces/cursor") + $(find "$hatsu_root/surfaces/cursor/agents" -maxdepth 1 -name '*.md' -type f | wc -l | tr -d ' ') + 1 + 1 ))
...
[ "$(find "$antigravity_fixture/.agents/agents" -maxdepth 1 -name '*.md' -type f | wc -l | tr -d ' ')" = "$(find "$hatsu_root/surfaces/antigravity/agents" -maxdepth 1 -name '*.md' -type f | wc -l | tr -d ' ')" ] || fail "Antigravity personas were not fully installed under .agents/agents"
...
antigravity_installed_count=$(( $(count_skills "$hatsu_root/surfaces/antigravity") + 1 + 1 \
  + $(count_files "$hatsu_root/surfaces/antigravity/hooks" '*.sh') \
  + $(find "$hatsu_root/surfaces/antigravity/agents" -maxdepth 1 -name '*.md' -type f | wc -l | tr -d ' ') ))
