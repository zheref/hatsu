...
summary: Pair a new device with this machine and register it as a named launch target, once — walk the maintainer through the on-device steps, verify with the platform's own probe, then write
---
