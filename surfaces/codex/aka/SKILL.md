...
summary: Send the branch out — gyo (lint) before rewriting history, squash only unpushed commits, bring the base underneath them, gyo again if catch-up changed the tree, and push.
---
