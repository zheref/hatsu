...
summary: Render the current backlog as the Kurapika gate board — the same sweep, arguments and gate assignment as $backlog-state, painted as a Rikugan page by nen report render --variant
---
