...
summary: Cut a release tag locally, end to end — preconditions, one folded release-proposal PR the maintainer merges, the post-merge tag, then the CON-22 fan-out.
---
