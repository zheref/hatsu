...
Kotoamatsukami executes inside [`$aka`](../aka/SKILL.md) § 6 alongside
[`$tsukuyomi`](../tsukuyomi/SKILL.md), so the unit and end-to-end halves prove the same final
tree. [`$mukai`](../mukai/SKILL.md) step 6 consumes those existing artifacts for evidence and
