...
summary: Take a pushed branch through catch-up, review, impacted tests, coverage and evidence to one open PR, render its landing report, then end by immediately handing the PR to En.
---
