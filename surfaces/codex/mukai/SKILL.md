...
|---|---|---|---|
| 1 | **catch up** | [`$murasaki`](../murasaki/SKILL.md) | the base underneath the branch; changed source/tests trigger aka's regression helper before an update push |
...
| 5 | **publish the proved tree** | [`$murasaki`](../murasaki/SKILL.md) | final catch-up check; if it changes source/tests, invalidate regression and coverage and return to steps 3–4; only an unchanged, fully proved tree is pushed |
