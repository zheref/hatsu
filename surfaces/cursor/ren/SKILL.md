...
| 3 | **verify and commit** | [`/kokusen`](../kokusen/SKILL.md) | every `iteration.checks` verb over the **finished** tree, red refused; then triage, an ask on what is flagged, one shaped commit — local only |
