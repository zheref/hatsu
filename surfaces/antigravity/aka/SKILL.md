...
- **No agent ever prompts for it.** Not [`/jutaisho`](../jutaisho/SKILL.md) at the end of a
  turn, not [`/spiritual-message`](../spiritual-message/SKILL.md) in a report, not a composite offering it as a
...
[`/spiritual-message`](../spiritual-message/SKILL.md) § 5 owns this: the `turn` variant, re-rendered at the same
...
spiritual-message § 5a). Red lint, a semantic conflict from [`/ao`](../ao/SKILL.md), or any other stop
