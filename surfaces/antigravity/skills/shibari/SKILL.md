...
Shibari is **step 8 of [`/mukai`](../mukai/SKILL.md)'s run** — the last step that writes
...
> not a silence, which is the same rule [`/pr-state`](../pr-state/SKILL.md) states positively:
