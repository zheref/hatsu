...
[`/spiritual-message`](../spiritual-message/SKILL.md) § 1 records, and the shape is deliberately ao's, because the
...
> tree nothing proved. [`/ao`](../ao/SKILL.md) § 3 owns the invocation; murasaki calls ao.
>
