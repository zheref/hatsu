...
Every review, coverage-test, snapshot, or catch-up source/test change invalidates evidence and returns
through kokusen plus aka's narrow verification helper before the already-published update is pushed.
A final catch-up that changes the tree pushes nothing and loops through regression and coverage.
