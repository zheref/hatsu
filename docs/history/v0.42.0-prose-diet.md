...
> do with the effort (`docs/surfaces/evidence/surfaces.md` § 7, F14). So:
>
...
`docs/surfaces/evidence/surfaces.md` §§ 3.4, 3.5, 7, which § 7 of the rewritten skill now cites instead of restating.
