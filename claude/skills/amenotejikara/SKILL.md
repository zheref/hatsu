...
| `1` | a git step failed part-way, or the record is malformed | relay it verbatim, then `status`; the parked commit is still pinned, and `git checkout <parked> -- .` recovers it |
