...
Byakugan is [`hatsu:mukai`](../mukai/SKILL.md)'s coverage step, after kotoamatsukami has run the
...
This is what used to be named [`hatsu:gyo`](../gyo/SKILL.md) when gyo meant coverage. Gyo is
...
[`hatsu:tsukuyomi`](../tsukuyomi/SKILL.md)'s (focused). Byakugan assumes they already ran on this
...
[`hatsu:kotoamatsukami`](../kotoamatsukami/SKILL.md), not into a second suite hidden inside
...
[`hatsu:kokusen`](../kokusen/SKILL.md) commits it, [`hatsu:kotoamatsukami`](../kotoamatsukami/SKILL.md)
...
The ladder is per file. The stop is [`hatsu:jutaisho`](../jutaisho/SKILL.md)'s shape, in full.
