...
the moment the PR was opened**. [`hatsu:mukai`](../mukai/SKILL.md) continues through this handover;
...
| 6 | **the bell and gate handoff** | [`hatsu:jutaisho`](../jutaisho/SKILL.md) | **after verified Ready**, and only then; this is En's successful terminus |
