...
**The reviewer-round policy is [`hatsu:sharingan`](../sharingan/SKILL.md) § 5's, written there in
...
| 7 | **retained readiness report** | [`hatsu:rikugan`](../rikugan/SKILL.md) `as final` | after the bell; this is En's successful terminus |
...
**Do not start [`hatsu:third-hand`](../third-hand/SKILL.md) from this file.** When this run has
