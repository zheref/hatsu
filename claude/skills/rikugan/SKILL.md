...
```
hatsu:rikugan [as <turn | landing | final>] [against <base>]
```
...
```bash
nen parse rikugan --grammar "as [<variant:turn|landing|final>] against [<base>]" --line "<the invocation, minus the hatsu:rikugan prefix>"
```
