...
| **`final`** | [`hatsu:en`](../en/SKILL.md)'s last step, after verified current-head readiness and before the human merge/vote | 01–09 **+ 10 Tests run + 11 Touched coverage** | **Yes** — the only one with a file of its own |
