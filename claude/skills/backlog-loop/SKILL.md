...
layer) and hand it to [`build`](../build/SKILL.md) (`hatsu:build <CODE>#<N>`); once a PR exists,
[`sharingan`](../sharingan/SKILL.md) (`hatsu:sharingan <CODE>#<N> to <G2|G4>`) takes it the rest of
the way.
