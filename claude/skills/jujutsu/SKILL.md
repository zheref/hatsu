...
**Then the pull request, at the **declaration gate** (**G4** in a canon repository, **G2** in a consumer one).** [`hatsu:aka`](../aka/SKILL.md) publishes the branch on the
