...
| 6 | **bell** | [`hatsu:jutaisho`](../jutaisho/SKILL.md) (§ 1 decides whether the page's ask makes it a stop) | the rungs the workflow declares — and a stop only if one is genuinely due |
